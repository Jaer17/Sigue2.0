 ...
 * @author Nataly
 */
public class CRMDescoBajaMoro extends javax.swing.JFrame {

    /**
     * Creates new form montoPagar
     */
    public CRMDescoBajaMoro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Desconexion por Morosidad");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel2.setText("PERSONA QUE LLAMA:");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel3.setText("MONTO A PAGAR PARA RX:");
    ...
    vista=("PERSONA QUIEN LLAMA: "+Nom
            +"\nMONTO A PAGAR PARA RX: ¢ "+Mon
            +"\nCORRESPONDIENTE A LOS MESES: "+m1+m2+m3+m4+m5+m6+m7+m8+m9+m10+m11+m12);
    tCRM.setText(vista);
...
AssistCRM obj=new AssistCRM();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CRMDescoBajaMoro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CRMDescoBajaMoro().setVisible(true);
            }
        });
    }
