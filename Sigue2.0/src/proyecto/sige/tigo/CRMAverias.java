...
public class CRMAverias extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("ESTADO DE LAS LUCES DEL CM :");
        ...
        cbMotivo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "POWER Y LA DE RECEIVE PARPADEANDO", "POWER, RECEIVE Y SEND PARPADEANDO", "POWER Y RECEIVE (DOWNSTREAM)", "POWER, RECEIVE (DOWNSTREAM) Y SEND (UPSTREAM)" }));
    ...
    vista=("PERSONA QUIEN LLAMA: "+Nom
            +"\nDIRECCION: "+Dia
            +"\nTAP: "+Mon
            +"\nESTADO DE LAS LUCES DEL CM : "+Moti
            +"\nTELEFONO:"+Regi
            +"\nOBSERVACION: "+Nom+" llama para reportar que no tiene"
            +"servicio de BBI, el CM se encuentra Desenganchado y "+Moti);
    tCRM.setText(vista);
